    ...
    return (
        <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <label htmlFor="audio" className="block text-center bg-gray-700 hover:bg-gray-800 text-white py-2 px-4 rounded-full cursor-pointer">Subir Audio <input type="file" onChange={(e) => setAudio(e.target.files[0])} accept="audio/*" required /></label>
